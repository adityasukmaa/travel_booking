...
<html lang="en">
    <head>
        ...
        <title>TravelCLass - @yield('title')</title>

        {{-- Link Bootstrap --}}
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">

        {{-- Link Simple Datatables --}}
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{ route ('superadmin.dashboard') }}">TravelClass</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    {{-- <a class="nav-link" href="{{ route ('manage-users') }}">Data Pengguna</a> --}}
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{ route('report-bookings') }}">Laporan Pemesanan</a>
                                </nav>
                            </div>
                            <div class="sb-sidenav-menu-heading">Tambahan</div>
                            <a class="nav-link" href="{{ route ('manage-trips') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Perjalanan
                            </a>
                            <a class="nav-link" href="{{ route ('manage-bookings') }}">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; TravelClass 2024</div>
                            <div>
