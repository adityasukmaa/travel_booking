        ...
        <div class="row gx-5 justify-content-left">
            <div class="col-lg-6">
                <div class="text-left my-5">
                    <h1 class="display-5 fw-bolder text-white mb-2">Keliling Dunia Perlu Travel <span style="color:#F5B963">Class</span></h1>
                    <p class="lead text-white-55 mb-4">Jelajahi kenyamanan dan keamanan perjalanan Anda dengan menggunakan jasa mobil travel kami. Nikmati layanan profesional, armada yang terawat, dan pengalaman perjalanan yang menyenangkan.</p>
...
<section class="py-5 border-bottom" id="features">
    <div class="container px-5 my-5">
        <div class="row gx-5">
            ...
            <div class="col-lg-4 mb-5 mb-lg-0">
                <div class="feature bg-success bg-gradient text-white rounded-3 mb-3"><i class="bi bi-compass"></i></div>
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex">
                            ...
                            <div class="ms-4">
                                <p class="mb-1">Our family trip was well organized and stress-free thanks to your amazing team. Highly recommend!</p>
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <div class="d-flex">
                            <div class="flex-shrink-0"><i class="bi bi-chat-right-quote-fill text-primary fs-1"></i></div>
                            <div class="ms-4">
                                <p class="mb-1">I had an incredible solo adventure that was nothing short of spectacular. Can't wait for my next trip!</p>
